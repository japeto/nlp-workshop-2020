...
input_set = model.PairSet.create_from_file(args.input)
input_set.find_new_pairs(output= args.output, result_count= args.result_count, neighborhood=args.neighborhood,
                         method= method_names(args.method),distance=similarity_names(args.similarity),
